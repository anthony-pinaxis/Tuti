...
( function($) {
	...
	$.extend($.ui.gmap.prototype, {
		...
		placesSearch: function(placeSearchRequest, callback) {
			this.get('services > PlacesService', new google.maps.places.PlacesService(this.get('map'))).textSearch(placeSearchRequest, callback);
		},
		placeDetails : function(placeDetailReference, callback){
			this.get('services > PlacesService', new google.maps.places.PlacesService(this.get('map'))).getDetails({reference:placeDetailReference},callback);
		},
